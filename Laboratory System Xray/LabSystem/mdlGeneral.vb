...
Module mdlGeneral
    ...
    Public ConnString, SqlConnString, UserStatus, UserName, UserPassword, SysOperator, DiscountBy, RptUser, gblAccType, gblInput As String
    ...
    Public Sub ExecuteSqlQuery(ByVal Obj As SqlDataAdapter, ByVal ObjDataSet As DataSet, ByVal MyQuery As String, ByVal TableName As String, ByVal SqlConn As SqlConnection)
        ...
        '// OLD CONNECTION STRING ('SqlConn = New SqlConnection("Data Source=" & ServerName & ";Initial Catalog=XLAB;NETWORK LIBRARY=DBMSSOCN;Integrated Security=SSPI;"))
    ...
    Public Function GenerateMax_ID(ByVal tblName As String, ByVal strField As String) As Integer
        ...
        Using Conn As New SqlConnection("Data Source=" & ServerName & ";Initial Catalog=XLAB;NETWORK LIBRARY=DBMSSOCN;Integrated Security=SSPI;")
    ...
    Public Function CheckDatabaseExists(ByVal server As String, ByVal database As String) As Boolean
        ...
        Dim connString As String = ("Data Source=SQLNCLI10;Integrated Security=SSPI;Persist Security Info=False;User ID=sa;Password=" & ServerPwd & ";Data Source=" & server & ";Database=master;")
    ...
    Public Function CheckTableExists() As Boolean
        ...
        Dim conn As New SqlConnection("Data Source=SQLNCLI10;Integrated Security=SSPI;Persist Security Info=False;User ID=sa;Password=" & ServerPwd & ";Data Source=" & ServerName & ";DATABASE=XLAB;")  'Creates a new connection object
        ...
        cmd.CommandText = "SELECT COUNT(*) " & _
                           "FROM sys.objects " & _
                           "WHERE object_id = OBJECT_ID(N'[dbo].[PATIENT]') " & _
                           "AND type in (N'U')"
    ...
    Public Sub GetConnectionString()
        Connection = New SqlConnection("Data Source=SQLNCLI10;Integrated Security=SSPI;Persist Security Info=False;User ID=sa;Password=" & ServerPwd & ";Data Source=" & ServerName & ";DATABASE=XLAB;")
    End Sub
