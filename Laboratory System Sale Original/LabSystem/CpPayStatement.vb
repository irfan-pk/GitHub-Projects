...
Public Class CpPayStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Solutions.CpPayStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCpPayStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CpPayStatement = New CpPayStatement
        rpt.Site = Me.Site
        Return rpt
    End Function
