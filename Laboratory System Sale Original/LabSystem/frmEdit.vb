...
Public Class frmEdit
        ...
        If isChanged = True Then
            Try
                ...
                mySql = "UPDATE PATIENT SET P_NAME = '" & StrConv(txtName.Text.Trim, VbStrConv.ProperCase) & "'," & _
                        ...
                        " P_CNIC = " & Val(txtPanel.Text.Trim) & "," & _
                        " P_REF_BY = '" & StrConv(txtRefer.Text.Trim, VbStrConv.ProperCase) & "'," & _
                        " P_REFER_2 = '" & StrConv(txtRefer.Text.Trim, VbStrConv.ProperCase) & "'," & _
                        " P_CP = '" & "LAB" & "'," & _
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            lblDues.Text = Val(lblTotal.Text)
            txtDiscount.Text = "0"
            txtPaid.Text = "0"
            txtCompli.Text = "0"
        ...
        Try
            ...
            If objDataTable.Rows.Count > 0 Then
                For Each objDataRow In objDataTable.Rows
                    ...
                    txtReference.Text = objDataRow.Item("p_refer_2").ToString.Trim
