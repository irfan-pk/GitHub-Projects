...
Public Class frmDonorProfile
    ...
    Private Sub LoadDB()
        ...
        Try
            ...
            ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, CommandText, "DONOR_TABLE", Connection)
            SqlDataAdapt.Fill(Me.DonorDataSet, "DONOR_TABLE")
    ...
    Private Sub RefreshDB()
        ...
        Try
            ...
            ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, QueryText, "DONOR_TABLE", Connection)
            SqlDataAdapt.Fill(Me.DonorDataSet, "DONOR_TABLE")
            Me.DonorBindingSource.DataSource = Me.DonorDataSet
            Me.DonorBindingSource.DataMember = "DONOR_TABLE"
            Me.DonorDataGrid.Update()
