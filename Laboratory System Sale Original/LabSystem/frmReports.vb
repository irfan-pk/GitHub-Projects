    ...
    Private Sub frmReports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If gblReportOption.ToUpper = "DUESSTAT" Or gblReportOption = "INVDUESSTAT" Then
                If (gblCpName.Trim <> "ALL" Or gblCpName.Trim <> "all") And (RptUser.Trim = "ALL" Or RptUser.Trim = "all") Then CommandText = "Select * from PATIENT WHERE p_date_sample >= CONVERT(DATETIME,'" & Format(fromDate, "yyyy-MM-dd") & " 00:00:00',102) AND p_date_sample <= CONVERT(DATETIME,'" & Format(toDate, "yyyy-MM-dd") & " 00:00:00',102) AND (P_REF_BY = '" & StrConv(gblCpName.Trim, VbStrConv.Uppercase) & "') AND (P_DUES > 0)"
                If (gblCpName.Trim = "ALL" Or gblCpName.Trim = "all") And (RptUser.Trim <> "ALL" Or RptUser.Trim <> "all") Then CommandText = "Select * from PATIENT WHERE p_date_sample >= CONVERT(DATETIME,'" & Format(fromDate, "yyyy-MM-dd") & " 00:00:00',102) AND p_date_sample <= CONVERT(DATETIME,'" & Format(toDate, "yyyy-MM-dd") & " 00:00:00',102) AND (P_OPERATOR = '" & StrConv(RptUser.Trim, VbStrConv.Uppercase) & "') AND (P_DUES > 0)"
                If (gblCpName.Trim = "ALL" Or gblCpName.Trim = "all") And (RptUser.Trim = "ALL" Or RptUser.Trim = "all") Then CommandText = "Select * from PATIENT WHERE p_date_sample >= CONVERT(DATETIME,'" & Format(fromDate, "yyyy-MM-dd") & " 00:00:00',102) AND p_date_sample <= CONVERT(DATETIME,'" & Format(toDate, "yyyy-MM-dd") & " 00:00:00',102) AND (P_DUES > 0)"
            End If
            ...
            If gblReportOption.ToUpper = "PATIENTSTAT" Then
                If (gblCpName.Trim <> "ALL" Or gblCpName.Trim <> "all") And (RptUser.Trim = "ALL" Or RptUser.Trim = "all") Then CommandText = "Select * from PATIENT WHERE p_date_sample >= CONVERT(DATETIME,'" & Format(fromDate, "yyyy-MM-dd") & " 00:00:00',102) AND p_date_sample <= CONVERT(DATETIME,'" & Format(toDate, "yyyy-MM-dd") & " 00:00:00',102) AND (P_REF_BY = '" & StrConv(gblCpName.Trim, VbStrConv.Uppercase) & "')"
                If (gblCpName.Trim = "ALL" Or gblCpName.Trim = "all") And (RptUser.Trim <> "ALL" Or RptUser.Trim <> "all") Then CommandText = "Select * from PATIENT WHERE p_date_sample >= CONVERT(DATETIME,'" & Format(fromDate, "yyyy-MM-dd") & " 00:00:00',102) AND p_date_sample <= CONVERT(DATETIME,'" & Format(toDate, "yyyy-MM-dd") & " 00:00:00',102) AND (P_OPERATOR = '" & StrConv(RptUser.Trim, VbStrConv.Uppercase) & "')"
                If (gblCpName.Trim = "ALL" Or gblCpName.Trim = "all") And (RptUser.Trim = "ALL" Or RptUser.Trim = "all") Then CommandText = "Select * from PATIENT WHERE p_date_sample >= CONVERT(DATETIME,'" & Format(fromDate, "yyyy-MM-dd") & " 00:00:00',102) AND p_date_sample <= CONVERT(DATETIME,'" & Format(toDate, "yyyy-MM-dd") & " 00:00:00',102)"
            End If
            ...
            If gblReportOption.ToUpper = "TESTS" Then
