...
Public Class frmMain
    ...
    Private Sub Administrator_MenuForms(ByVal FormName As Form)
        If gblPrliviges > 1 Then MsgBox("Your are not authorized.", MsgBoxStyle.Information, My.Application.Info.ProductName) : Exit Sub
    ...
    Private Sub CrossMatchEntryToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Call Operators_Menu_Forms(frmCrossMatch)
    End Sub

    Private Sub DonorProfileToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Call Operators_Menu_Forms(frmDonorProfile)
    End Sub

    Private Sub CollectionPointBillingToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CollectionPointBillingToolStripMenuItem.Click
        Call Operators_Menu_Forms(frmBilling)
    End Sub
End Class
