...
Public Class frmPatient
    ...
    Private Sub frmPatient_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Connection.Close()
        Me.Focus()
        If gblPrliviges > 1 Then txtCompli.ReadOnly = True Else txtCompli.ReadOnly = False
    ...
    Private Sub txtPanel_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtPanel.KeyPress
    ...
    Private Sub txtRefer_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtRefer.KeyDown
        If e.KeyCode = Keys.Enter Then
            If txtRefer.Text = "" Then MsgBox("Please Select Referenced Doctor.", MsgBoxStyle.Information, My.Application.Info.ProductName) : txtRefer.Focus() Else txtReferencce.Focus()
            txtRefer.Text = StrConv(txtRefer.Text, VbStrConv.ProperCase)
        End If
    End Sub
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        ...
        Try
            ...
            Me.txtRefer.Text = String.Empty
            Me.cmbTitle.Text = "Mr."
            Me.cmbDTitle.Text = "Mr."
            Me.cmbVisitor.Text = String.Empty
            Me.txtYrs.Text = "00"
            Me.txtMth.Text = "00"
            Me.txtDay.Text = "00"
            Me.txtDName.Text = "x"
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If Val(txtCompli.Text) > 0 Then
            Rmks = InputBox("Please give reference for Complimentry Case.", "Remarks")
        ...
        Try
            ...
            If iCount > 0 And Sub_Addition = True Then
                Do Until iLoop = iCount
                    CommandText = "INSERT INTO RECEIPT(TCASENO,TCODE,TNAME,TCATG,TRATE,TQTY,TDATE,TMODE,TDELETE) VALUES (" & _
                             ...
                             Format(DateTime.Parse(DateTime.Now.ToShortDateString.ToString), "MM/dd/yyyy") & "','ADD',0)"
            ...
            If txtRefer.Text = "" Then
                svDataRow.Item("P_REF_BY") = "Self"
            Else
                svDataRow.Item("P_REF_BY") = StrConv(txtRefer.Text.Trim, VbStrConv.ProperCase)
            End If
            svDataRow.Item("P_REFER_2") = txtReferencce.Text.Trim
            svDataRow.Item("P_CP") = "LAB"
            ...
            txtDelTime.Text = Format(Now.AddHours(4), "hh:mm tt")
            svDataRow.Item("P_RPT_DATE") = Format(DateTime.Parse(txtDelDate.Text), "MM/dd/yyyy")
    ...
    Private Sub txtDAge_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDAge.KeyDown
        If e.KeyCode = Keys.Enter Then txtDAge.Text = Format(Val(txtDAge.Text), "00") : txtSlip.Focus()
    End Sub
    ...
    Private Sub cmbVisitor_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmbVisitor.KeyDown
        If e.KeyCode = Keys.Enter Then Me.ProcessTabKey(True) : txtDiscount.Focus()
    End Sub
    ...
    Private Sub txtReferencce_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtReferencce.GotFocus
        txtReferencce.SelectAll()
    End Sub

    Private Sub txtReferencce_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtReferencce.KeyDown
        If e.KeyCode = Keys.Enter Then
            txtCode.Focus()
        End If
    End Sub

    Private Sub txtReferencce_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtReferencce.LostFocus
        txtRefer.Text = StrConv(txtRefer.Text, VbStrConv.Uppercase)
    End Sub
End Class
