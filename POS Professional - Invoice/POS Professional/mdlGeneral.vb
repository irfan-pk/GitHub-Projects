...
Module mdlGeneral
    ...
    Public Sub GetConnectionString()
        Connection = New SqlConnection("Data Source=" & ServerName & ";Initial Catalog=" & ServerDatabase & ";User ID=" & ServerID & ";Password=" & ServerPwd & ";DATABASE=" & ServerDatabase & ";")
    End Sub

    Public Function CheckDatabaseExists(ByVal server As String, ByVal database As String) As Boolean

        Dim connString As String = ("Data Source=" & ServerName & ";Initial Catalog=master;User ID=" & ServerID & ";Password=" & ServerPwd & ";")
    ...
    Public Function CheckTableExists(ByVal tblname As String) As Boolean
        ...
        Dim conn As New SqlConnection("Data Source=" & ServerName & ";Initial Catalog=" & ServerDatabase & ";User ID=" & ServerID & ";Password=" & ServerPwd & ";DATABASE=" & ServerDatabase & ";")  'Creates a new connection object
