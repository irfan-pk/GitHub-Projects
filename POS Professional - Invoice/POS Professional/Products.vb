...
Public Class Products
    ...
    Private Sub BindingNavigatorUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BindingNavigatorUpdate.Click
        If Val(txtWholeSale.Text) < Val(txtPurchPrice.Text) Then
            MessageBox.Show("WholeSale Price should'nt be less than purchase price.", "Price Error", MessageBoxButtons.OK, MessageBoxIcon.Information)
            txtWholeSale.Focus()
            Exit Sub
        End If
        If Val(txtSalePrice.Text) < Val(txtWholeSale.Text) Then
            MessageBox.Show("Sale Price should'nt be less than wholesale price.", "Price Error", MessageBoxButtons.OK, MessageBoxIcon.Information)
            txtSalePrice.Focus()
            Exit Sub
        End If
    ...
    Private Sub txtUnitPack_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtUnitPack.Leave
        txtStock.Text = Val(txtUnitPack.Text) * Val(txtPackQty.Text)
    End Sub
End Class