        ...
        If SaleMode = True Then
            ...
            If SaleMode = True Then
                ...
                MasterQuery = "INSERT INTO SALE_MASTER VALUES ('" & _
                            ...
                            gblPayment & "," & _
                            "0" & "," & _
                            "'ACCOUNT'," & Val(lblNetDues.Text.Trim) & ",0,0,'" & Format(Date.Parse(lblDate.Text.Trim), "MM/dd/yyyy") & "',0)"
                ...
                If SaleDataGrid.RowCount > -1 Then
                    ...
                    For Each OutRow As DataGridViewRow In SaleDataGrid.Rows
                        HoldQuery = "INSERT INTO SALE_DETAIL VALUES ('" & _
                                                             ...
                                                             lblUserID.Text.Trim & "',0,0,'" & OutRow.Cells(7).Value.ToString & "','" & OutRow.Cells(8).Value.ToString & "',0,'x'," & SortID & ",'" & OutRow.Cells(9).Value.ToString & "'," & Val(OutRow.Cells(5).Value.ToString) & ")"
            ...
            If SaleDataGrid.RowCount > -1 Then
                ...
                For Each OutRow As DataGridViewRow In SaleDataGrid.Rows
                    HoldQuery = "INSERT INTO SALE_DETAIL_HOLD VALUES ('" & _
                                                         ...
                                                         lblUserID.Text.Trim & "',0,0,'" & OutRow.Cells(7).Value.ToString & "','" & OutRow.Cells(8).Value.ToString & "',0,'x'," & SortID & ",'" & OutRow.Cells(9).Value.ToString & "')"
                    ProcessTransaction(HoldQuery)
                    SortID += 1
                Next OutRow
                ...
                Using Conn As New SqlConnection("Data Source=" & ServerName & ";Initial Catalog=" & ServerDatabase & "; User ID=" & ServerID & ";Password=" & ServerPwd & ";DATABASE=" & ServerDatabase & ";")
            ...
            If SaleDataGrid.RowCount > -1 Then
                ...
                For Each OutRow As DataGridViewRow In SaleDataGrid.Rows
                    ...
                    Dim ReturnItemQuery = "INSERT INTO SALE_DETAIL VALUES ('" & _
                                                         ...
                                                         lblUserID.Text.Trim & "',0,0,'" & OutRow.Cells(7).Value.ToString & "','" & OutRow.Cells(8).Value.ToString & "',0,'x'," & SortID & ",'" & OutRow.Cells(9).Value.ToString & "',0)"
