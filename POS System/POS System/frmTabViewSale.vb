...
Public Class frmTabViewSale
        ...
        If dgMasterInfo1.RowCount > 0 Then
            If Val((dgMasterInfo1.Rows(dgMasterInfo1.CurrentRow.Index).Cells(0).Value.ToString())) > 0 Then
                ...
                If IsNumeric(SalePayment.Trim) And Val(SalePayment.Trim) > 0 Then
                    If Val(SalePayment.Trim) > Credit Then gblMessage = "Payment Invalid" : frmMsgStatus.ShowDialog(Me) : Exit Sub
    ...
    Private Sub cmdPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPreview.Click
        ...
        frmSummaryReports.MdiParent = frmMain
        frmSummaryReports.Show()
    End Sub
