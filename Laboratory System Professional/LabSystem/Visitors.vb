...
Public Class Visitors
    ...
    Private Sub BindingNavigatorDeleteItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BindingNavigatorDeleteItem.Click
        ...
        ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, DeleteQuery, "VISITOR_TABLE", Connection)
    ...
    Private Sub BindingNavigatorSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BindingNavigatorSave.Click
        ...
        If Editing = True And Addition = False Then Edit_Update_Query = "UPDATE VISITOR_TABLE SET VISITOR_NAME = '" & StrConv(txtName.Text.Trim, VbStrConv.ProperCase) & "', DOC_PHONE = '" & txtPhone.Text.Trim & "' WHERE DOC_NAME = '" & EditString & "'"
    ...
    Private Sub LoadDB()
        Try
            ...
            ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, LoadQuery, "VISITOR_TABLE", Connection)
            SqlDataAdapter.Fill(Me.VisDataSet, "VISITOR_TABLE")
    ...
    Private Sub RefreshDB()
        Try
            ...
            ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, CommandText, "VISITOR_TABLE", Connection)
            SqlDataAdapter.Fill(Me.VisDataSet, "VISITOR_TABLE")
            Me.VisBindingSource.DataSource = Me.VisDataSet
            Me.VisBindingSource.DataMember = "VISITOR_TABLE"
