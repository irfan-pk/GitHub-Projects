...
Public Class AccountReports
    ...
    Private Sub frmAccReports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If gblReportOption = "GENERAL" Then CommandText = "SELECT * FROM GENERAL_JOURNAL WHERE GEN_DATE >= CONVERT(DATETIME,'" & Format(DateTime.Parse(fromDate), "yyyy-MM-dd") & " 00:00:00', 102) AND GEN_DATE <= CONVERT(DATETIME,'" & Format(DateTime.Parse(toDate), "yyyy-MM-dd") & " 00:00:00', 102) ORDER BY GEN_DATE, GEN_TRAN_ID" : gblTableName = "GENERAL_JOURNAL"
            ...
            If gblReportOption = "EXPREVENUE" Then CommandText = "Select * from PETTY_JOURNAL WHERE MONTH(P_TRAN_DATE) >= " & Month(Format(DateTime.Parse(fromDate), "yyyy-MM-dd")) & " AND MONTH(P_TRAN_DATE) <= " & Month(Format(DateTime.Parse(toDate), "yyyy-MM-dd")) & " ORDER BY P_TRAN_ID" : gblTableName = "PETTY_JOURNAL"
