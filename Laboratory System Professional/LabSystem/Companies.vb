...
Public Class Companies
    ...
    Private Sub LoadDB()
        Try
            ...
            ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, CommandText, "COMPANY", Connection)
            SqlDataAdapter.Fill(Me.CompanyDataSet, "COMPANY")
    ...
    Private Sub ToolStripSaveButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripSaveButton.Click
        ...
        If Addition = True And Editing = False Then
            ...
            ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, IDSql, "COMPANY", Connection)
    ...
    Private Sub RefreshDB()
        Try
            ...
            ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, QueryText, "COMPANY", Connection)
            SqlDataAdapter.Fill(Me.CompanyDataSet, "COMPANY")
            Me.CompanyBindingSource.DataSource = Me.CompanyDataSet
            Me.CompanyBindingSource.DataMember = "COMPANY"
            Me.CompanyDataGridView.Update()
