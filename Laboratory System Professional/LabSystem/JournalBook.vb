...
#Region "FORM EVENTS"
    ...
    Private Sub frmJournal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Dim grdForm As New LinearGradientBrush(rect, Color.Gray, Color.LightGray, LinearGradientMode.Vertical)
...
#End Region
    ...
    Private Sub txtDebit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDebit.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Call DebitTransaction(txtAccount.Text.Trim, "DR", Val(txtDebit.Text.Trim), gNarration.Trim, txtVoucher.Text.Trim)
        End If
    End Sub
    ...
    Private Sub txtCredit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCredit.KeyDown
        If e.KeyCode = Keys.Enter Then
            Call CreditTransaction(txtAccount.Text.Trim, "CR", Val(txtCredit.Text.Trim), gNarration.Trim, txtVoucher.Text.Trim)
        End If
    End Sub
...
#Region "JOURNAL ENTRIES PROCEDURES"
    ...
    Private Sub cmdGetTrans_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGetTrans.Click
        ...
        Execute_DatabaseTable_Query(SqlDataAdapter, Check_Trans_Date, Connection)
        Dim CHECK_TRANS As SqlDataReader = SqlDataAdapter.SelectCommand.ExecuteReader
        ...
        ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, Daily_Transaction_Query, "PATIENT", Connection)
        ...
        If Val(wCompl) > 0 Then Call DebitTransaction("Complimentary", "DR", wCompl, "Complimentary Cases Amount.", DailyVoucher)
        ...
        If wNet > 0 Then
            DebitTransaction("Cash", "DR", wNet, "Cash Received from dues debited for " & StrConv(strCp.Trim, VbStrConv.ProperCase), DailyVoucher)
            CreditTransaction("Lab Dues", "CR", wNet, "Lab Dues Credited for " & StrConv(strCp.Trim, VbStrConv.ProperCase), DailyVoucher)
        End If
    ...
    Private Sub cmdPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPost.Click
        ...
        If Val(txtTotDebit.Text) = Val(txtTotCredit.Text) Then
            ...
            Dim Post_Transactions As String = "INSERT INTO GENERAL_JOURNAL " & _
                                              ...
                                              "WHERE GEN_DATE = CONVERT(DATETIME,'" & Format(DateTime.Parse(dtpTransaction.Value.ToShortDateString.ToString), "yyyy-MM-dd") & " 00:00:00', 102) "
...
#End Region
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Execute_DatabaseTable_Query(SqlDataAdapter, "DELETE FROM GEN_TEMP WHERE GEN_TRAN_ID =" & Val(delTranID), Connection)
        Call Show_Journal_Transactions()
    End Sub
