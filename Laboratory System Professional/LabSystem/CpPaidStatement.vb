...
Public Class CpPaidStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Solutions.CpPaidStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCpPaidStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CpPaidStatement = New CpPaidStatement
        rpt.Site = Me.Site
        Return rpt
    End Function
