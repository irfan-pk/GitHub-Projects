...
Public Class ReferenceList
    ...
    Private Sub Get_CP_ID()
        ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, "Select * from CollectionPoint where CP_NAME = '" & StrConv(ListBoxRefer.Text.Trim.ToUpper, VbStrConv.ProperCase) & "'", "CollectionPoint", Connection)
