...
Public Class SystemUser
    ...
    Private Sub LoadDB()
        Try
            ...
            ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, CommandText, "USERS", Connection)
            ...
            Me.txtName.DataBindings.Add("TEXT", UserbindingSource, "USERNAME")
            ...
            Me.cmbSection.DataBindings.Add("TEXT", UserbindingSource, "USERSECTION")
            Addition = False
            Editing = False
    ...
    Private Sub BindingNavigatorDeleteItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BindingNavigatorDeleteItem.Click
        ...
        If MsgBox("Are you sure to delete ('" & txtName.Text.Trim.ToUpper & "') ?", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, My.Application.Info.ProductName) = MsgBoxResult.Ok Then
            ...
            ExecuteSqlQuery(SqlDataAdapter, SqlDataSet, DeleteQuery, "USERS", Connection)
        Else
            Me.UsersDataGridView.RefreshEdit()
    ...
    Private Sub ToolStripSaveButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripSaveButton.Click
        ...
        If Editing = True And Addition = False Then Edit_Update_Query = "UPDATE USERS SET USERID = '" & txtUserID.Text.Trim.ToUpper & "', USERNAME = '" & txtName.Text.Trim.ToUpper & "', PASSWORD = '" & txtPwd.Text.Trim & "', USERTYPE = '" & cmbUserType.Text.Trim.ToUpper & "', USERSTATUS = '" & txtStatus.Text.Trim.ToUpper & "', USERSECTION = '" & cmbSection.Text.Trim.ToUpper & "' WHERE USERID = '" & EditString & "'"
        If Addition = True And Editing = False Then Edit_Update_Query = "INSERT INTO USERS VALUES('" & txtUserID.Text.Trim.ToUpper & "','" & txtName.Text.Trim.ToUpper & "','" & txtPwd.Text.Trim.ToUpper & "','" & cmbUserType.Text.Trim.ToUpper & "','" & txtStatus.Text.Trim.ToUpper & "','" & cmbSection.Text.Trim.ToUpper & "')"
