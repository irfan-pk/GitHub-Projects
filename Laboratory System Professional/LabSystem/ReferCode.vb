...
Public Class ReferCode
    ...
    Private Sub frmProductCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            Try
                ...
                ExecuteSqlQuery(TransDataAdapter, TransDataSet, CommandText, "COLLECTIONPOINT", Connection)
                gblRefer = TransDataSet.Tables("COLLECTIONPOINT").Rows(0).Item("CP_NAME").ToString.Trim
                Connection.Close()
                'Me.Close()
    ...
    Private Sub MainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Execute_DatabaseTable_Query(TransDataAdapter, CommandText, Connection)
        Dim Reader As SqlDataReader = TransDataAdapter.SelectCommand.ExecuteReader
