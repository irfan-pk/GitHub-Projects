...
namespace WholeSaleApplication
{
    public partial class AccountBook : Form
    {
        ...
        private void DgvAddressBook_CellMouseEnter(object sender, DataGridViewCellEventArgs e)
        {
            //if (!(DgvAddressBook.Rows[e.RowIndex].Cells[e.ColumnIndex].GetType() == typeof(DataGridViewImageCell))) return;
            //System.Windows.Forms.ToolTip tlp = new System.Windows.Forms.ToolTip();
            //tlp.IsBalloon = true;
            //tlp.AutoPopDelay = 1000;
            //tlp.AutomaticDelay = 300;
            //tlp.BackColor = Color.DodgerBlue;
            //tlp.SetToolTip(DgvAddressBook, "Double Click to edit..");
        }
    }
}
