...
Public Class CpCollStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Solutions.CpCollStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCpCollStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CpCollStatement = New CpCollStatement
        rpt.Site = Me.Site
        Return rpt
    End Function
