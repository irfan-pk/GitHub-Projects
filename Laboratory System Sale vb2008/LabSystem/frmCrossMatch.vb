    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        If objDataTable.Rows.Count > 0 Then
            For Each objDataRow In objDataTable.Rows
                ...
                txtPaid.Text = objDataRow.Item("P_COMPLIMENT")
                ...
                While Get_Max.Read
                    If Not Get_Max Is Nothing Then Exit Sub
        ...
        If e.KeyCode = Keys.Enter Then
            Try
                ...
                Try
                    ...
                    If Mode = False Then wTotal = wTotal + Val(strTrate)
                    ...
                    If Mode = False Then txtTotal.Text = wTotal
            ...
            Else
                ...
                If Return_Response = 0 Then
                    Try
                        ...
                        Dim Get_Max As SqlDataReader = SqlDataAdapt.SelectCommand.ExecuteReader
                        While Get_Max.Read
                            wDonor_Pid = Get_Max.Item("MAX_ID") + 1
                        End While
                        If Not Get_Max Is Nothing Then Get_Max.Close()
                        'wDonor_Pid = wDonor_Pid + 1
