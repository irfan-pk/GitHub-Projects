...
Public Class frmPatient_National
    ...
    Private Sub frmPatient_National_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        ...
        Try
            ...
            Dim MaxSn As String = ""
            Dim cpReader As SqlDataReader
            ExecuteSqlQuery(SqlDataAdapt, myDataSet, "Select Max(P_NUM) AS MAX_ID from PATIENT_NATIONAL", "PATIENT_NATIONAL", Connection)
            cpReader = SqlDataAdapt.SelectCommand.ExecuteReader
            While cpReader.Read
            ...
            ExecuteSqlQuery(SqlDataAdapt, myDataSet, "Select Max(P_SNO) AS MAX_ID from PATIENT_NATIONAL WHERE P_DATE_SAMPLE = CONVERT(DATETIME,'" & Format(DateTime.Parse(Date.Now.ToShortDateString), "MM/dd/yyyy") & " 00:00:00',102)", "PATIENT", Connection)
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim IF_EXIST_RECORD As String = "SELECT COUNT(P_NUM) AS EXPR_1 FROM PATIENT_NATIONAL WHERE P_NUM = " & Val(txtRecNo.Text)
        ...
        Try
            ...
            If iCount > 0 And Sub_Addition = True Then
                Do Until iLoop = iCount
                    CommandText = "INSERT INTO RECEIPT_NATIONAL(TCASENO,TCODE,TNAME,TCATG,TRATE,TQTY,TDATE,TMODE) VALUES (" & _
                             Val(txtRecNo.Text) & ",'" & _
            ...
            Dim svSql As String = "Select * from PATIENT_NATIONAL WHERE P_NUM = " & Val(txtRecNo.Text)
            SqlDataAdapt = New SqlDataAdapter(svSql, Connection)
            SqlDataAdapt.Fill(svDataSet, "PATIENT_NATIONAL")
            Connection.Close()
            ...
            svDataRow = svDataSet.Tables("PATIENT_NATIONAL").NewRow()
            svDataRow.Item("P_NUM") = Val(txtRecNo.Text.Trim)
            svDataRow.Item("P_SNO") = 0
            ...
            svDataSet.Tables("PATIENT_NATIONAL").Rows.Add(svDataRow)
            SqlDataAdapt.Update(svDataSet, "PATIENT_NATIONAL")
        ...
        Try
            ...
            If Val(lblDues.Text) > 0 Then
                ...
                If Val(strDiff) <> 0 And DueAmount > 0 Then
                    CommandText = "UPDATE PATIENT_NATIONAL SET P_DEL_OK = 'Yes', P_DEL_DATE = '" & _
        ...
        Try
            ...
            If objDataTable.Rows.Count > 0 Then
                For Each objDataRow In objDataTable.Rows
                    ...
                    TestListView.Items.Clear()
                    ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, "SELECT * FROM RECEIPT_NATIONAL WHERE TCASENO = " & Val(gblFind.Trim), "RECEIPT_NATIONAL", Connection)
    ...
    Private Sub cmdPSlip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPSlip.Click
        ...
        If Len(gblFind) > 0 Then
            ...
            gblReportName = ".\" & "Reports\NationalPatientSlip.rpt"
    ...
    Private Sub cmdLSlip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLSlip.Click
        ...
        If Len(gblFind) > 0 Then
            gblReportOption = "NPRECEIPT"
            'DiskReport = "LabSlip"
            gblReportName = ".\" & "Reports\NationalLabSlip.rpt"
