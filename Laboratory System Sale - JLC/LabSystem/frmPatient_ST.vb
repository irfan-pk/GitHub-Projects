...
Public Class frmPatient_ST
    ...
    Private Sub frmPatient_ST_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        ...
        Try
            ...
            Dim MaxSn As String = ""
            Dim cpReader As SqlDataReader
            ExecuteSqlQuery(SqlDataAdapt, myDataSet, "Select Max(P_NUM) AS MAX_ID from PATIENT_ST", "PATIENT_ST", Connection)
            cpReader = SqlDataAdapt.SelectCommand.ExecuteReader
            While cpReader.Read
            ...
            ExecuteSqlQuery(SqlDataAdapt, myDataSet, "Select Max(P_SNO) AS MAX_ID from PATIENT_ST WHERE P_DATE_SAMPLE = CONVERT(DATETIME,'" & Format(DateTime.Parse(Date.Now.ToShortDateString), "MM/dd/yyyy") & " 00:00:00',102)", "PATIENT", Connection)
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim IF_EXIST_RECORD As String = "SELECT COUNT(P_NUM) AS EXPR_1 FROM PATIENT_ST WHERE P_NUM = " & Val(txtRecNo.Text)
        ...
        Try
            ...
            If iCount > 0 And Sub_Addition = True Then
                Do Until iLoop = iCount
                    CommandText = "INSERT INTO RECEIPT_ST(TCASENO,TCODE,TNAME,TCATG,TRATE,TQTY,TDATE,TMODE) VALUES (" & _
                             Val(txtRecNo.Text) & ",'" & _
            ...
            Dim svSql As String = "Select * from PATIENT_ST WHERE P_NUM = " & Val(txtRecNo.Text)
            SqlDataAdapt = New SqlDataAdapter(svSql, Connection)
            SqlDataAdapt.Fill(svDataSet, "PATIENT_ST")
            Connection.Close()
            ...
            svDataRow = svDataSet.Tables("PATIENT_ST").NewRow()
            ...
            svDataSet.Tables("PATIENT_ST").Rows.Add(svDataRow)
            SqlDataAdapt.Update(svDataSet, "PATIENT_ST")
        ...
        Try
            ...
            If Val(lblDues.Text) > 0 Then
                ...
                If Val(strDiff) <> 0 And DueAmount > 0 Then
                    CommandText = "UPDATE PATIENT_ST SET P_DEL_OK = 'Yes', P_DEL_DATE = '" & _
        ...
        Try
            ...
            If objDataTable.Rows.Count > 0 Then
                For Each objDataRow In objDataTable.Rows
                    ...
                    TestListView.Items.Clear()
                    ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, "SELECT * FROM RECEIPT_ST WHERE TCASENO = " & Val(gblFind.Trim), "RECEIPT_ST", Connection)
    ...
    Private Sub cmdPSlip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPSlip.Click
        ...
        If Len(gblFind) > 0 Then
            ...
            gblReportName = ".\" & "Reports\STPatientSlip.rpt"
    ...
    Private Sub cmdLSlip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLSlip.Click
        ...
        If Len(gblFind) > 0 Then
            gblReportOption = "STRECEIPT"
            'DiskReport = "LabSlip"
            gblReportName = ".\" & "Reports\STLabSlip.rpt"
