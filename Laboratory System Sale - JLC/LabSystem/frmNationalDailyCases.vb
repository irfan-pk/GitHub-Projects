...
Public Class frmNationalDailyCases
    ...
    Private Sub frmNationalDailyCases_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Connection.Close()
        Me.frmBindingSource.Dispose()
    End Sub

    Private Sub frmNationalDailyCases_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadByFilter(ByVal FilterCriteria As String, ByVal RowColor As Color)
        ...
        Try
            ...
            End If
            ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, FilterCriteria, "PATIENT_NATIONAL", Connection)
            SqlDataAdapt.Fill(Me.frmDataSet, "PATIENT_NATIONAL")
            ...
            Me.frmBindingSource.DataMember = "PATIENT_NATIONAL"
    ...
    Private Sub Query_Decision()
        Select Case CaseString
            Case "ALL"
                If Me.ToolStripComboBox.Text.ToUpper = "ALL" Then StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DATE_SAMPLE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DATE_SAMPLE <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102))"
                If Me.ToolStripComboBox.Text.ToUpper <> "ALL" Then StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DATE_SAMPLE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DATE_SAMPLE <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_OPERATOR = '" & StrConv(Me.ToolStripComboBox.Text.Trim, VbStrConv.Uppercase) & "')"
                GridColor = Color.WhiteSmoke
            Case "DUES"
                If Me.ToolStripComboBox.Text.ToUpper = "ALL" Then StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DATE_SAMPLE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DATE_SAMPLE <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DUES > 0)"
                If Me.ToolStripComboBox.Text.ToUpper <> "ALL" Then StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DATE_SAMPLE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DATE_SAMPLE <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DUES > 0) AND (P_OPERATOR = '" & StrConv(Me.ToolStripComboBox.Text.Trim, VbStrConv.Uppercase) & "')"
                GridColor = Color.MistyRose
            Case "CLEARED"
                If Me.ToolStripComboBox.Text.Trim = "ALL" Then StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DATE_SAMPLE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DATE_SAMPLE <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DUES = 0)"
                If Me.ToolStripComboBox.Text.Trim <> "ALL" Then StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DATE_SAMPLE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DATE_SAMPLE <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DUES = 0) AND (P_OPERATOR = '" & StrConv(Me.ToolStripComboBox.Text.Trim, VbStrConv.Uppercase) & "')"
                GridColor = Color.PaleGreen
            Case "DELETED"
                StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DELETE_ON >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DELETE_ON <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DELETE > 0)"
                GridColor = Color.MistyRose
            Case "COMPLIMENTARY"
                StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_COMP_ON >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_COMP_ON <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_COMPLIMENT > 0)"
                GridColor = Color.Wheat
            Case "RECEIVED"
                If Me.ToolStripComboBox.Text.ToUpper = "ALL" Then StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DUE_RCV_DATE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DUE_RCV_DATE <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DUE_RCV > 0)"
                If Me.ToolStripComboBox.Text.ToUpper <> "ALL" Then StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DUE_RCV_DATE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DUE_RCV_DATE <= CONVERT(DATETIME,'" & Format(txtToDate.Value, "yyyy-MM-dd") & " 00:00:00',102)) AND (P_DUE_RCV > 0) AND (P_DUE_RCV_OPERATOR = '" & StrConv(Me.ToolStripComboBox.Text.Trim, VbStrConv.Uppercase) & "')"
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DATE_SAMPLE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "MM/dd/yyyy") & " 00:00:00',102)) AND (p_name LIKE '%" & findName.Trim.ToString & "%')"
    ...
    Private Sub ToolStripButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton2.Click
        Dim findName As String = InputBox("Please write patient name to find.", "Find Patient", "")
        If Len(findName) = 0 Then Exit Sub
        StrFilter = "SELECT * FROM PATIENT_NATIONAL WHERE (P_DATE_SAMPLE >= CONVERT(DATETIME,'" & Format(txtDate.Value, "MM/dd/yyyy") & " 00:00:00',102)) AND ((p_ref_by LIKE '%" & findName.Trim.ToString & "%') OR (p_refer_2 LIKE '%" & findName.Trim.ToString & "%'))"
        Call LoadByFilter(StrFilter, Color.WhiteSmoke)
    End Sub
    ...
    Private Sub Sub_Details()
        ...
        Execute_DatabaseTable_Query(SqlDataAdapt, "SELECT * FROM RECEIPT_NATIONAL WHERE TCASENO = " & Val(TestID), Connection)
        RcptDataSet.Clear()
        SqlDataAdapt.Fill(RcptDataSet, "RECEIPT_NATIONAL")
        RcptBindingSource.DataSource = RcptDataSet
        RcptBindingSource.DataMember = "RECEIPT_NATIONAL"
        Connection.Close()

    End Sub

    Private Sub frmDataGrid_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles frmDataGrid.KeyDown
