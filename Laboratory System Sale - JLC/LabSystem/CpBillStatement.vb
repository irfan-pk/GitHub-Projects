...
Public Class CpBillStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Solutions.CpBillStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCpBillStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CpBillStatement = New CpBillStatement
        rpt.Site = Me.Site
        Return rpt
    End Function
