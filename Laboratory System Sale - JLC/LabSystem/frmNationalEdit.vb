...
Public Class frmNationalEdit
    ...
    Private Sub frmNationalEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCode.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            Dim CommandText As String = "SELECT * FROM RECEIPT_NATIONAL where tcode = '" & txtCode.Text.Trim & "' AND TCASENO = " & Val(txtRecNo.Text.Trim)
            ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, CommandText, "RECEIPT_NATIONAL", Connection)
            SqlDataAdapt.Fill(SqlDataSet, "RECEIPT_NATIONAL")
            If SqlDataSet.Tables("RECEIPT_NATIONAL").Rows.Count > 0 Then
            ...
            Try
                ...
                If objDataTable.Rows.Count > 0 Then
                    ...
                    Dim EditCommandText As String = "INSERT INTO RECEIPT_NATIONAL VALUES (" & _
                                                    Val(txtRecNo.Text) & ",'" & _
                                                    strTCode & "','" & _
                                                    strTname & "','" & _
                                                    strCatg & "'," & _
                    ...
                    Connection.Close()
                    SqlDataAdapt.Dispose()
                    Call ShowGridData("SELECT * FROM RECEIPT_NATIONAL", "RECEIPT_NATIONAL", txtRecNo.Text)
                    txtCode.Clear()
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If isChanged = True Then
            Try
                ...
                mySql = "UPDATE PATIENT_NATIONAL SET P_NAME = '" & StrConv(txtName.Text.Trim, VbStrConv.ProperCase) & "'," & _
                        " P_DNAME = '" & StrConv(txtDName.Text.Trim, VbStrConv.ProperCase) & "'," & _
                        " P_AGE = '" & myAge & "'," & _
                        ...
                        " P_SNO = 0," & _
                        " P_DON_AGE = '" & txtDAge.Text.Trim & "" & Label26.Text.Trim & "'," & _
                        " P_DON_SEX = '" & lblSex.Text.Trim & "'" & _
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Dim strSql As String = "Select * from RECEIPT_NATIONAL WHERE TCODE = '" & DelString.Trim & "' AND TCASENO = " & Val(txtRecNo.Text)
        ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, strSql, "RECEIPT_NATIONAL", Connection)
        ...
        Try
            ...
            Dim CommandText As String = "DELETE FROM RECEIPT_NATIONAL WHERE TCODE = '" & DelString.Trim & "' AND TCASENO = " & Val(txtRecNo.Text)
            SqlDataAdapt.Dispose()
            SqlDataSet.Clear()
        ...
        End Try
        ' Refresh Data Grid
        Call ShowGridData("SELECT * FROM RECEIPT_NATIONAL", "RECEIPT_NATIONAL", txtRecNo.Text.Trim)
        Connection.Close()
        SqlDataAdapt.Dispose()
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        Try
            ...
            Dim strSql As String = "Select * from PATIENT_NATIONAL WHERE P_NUM = " & Val(gblFind.Trim)
            ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, strSql, "PATIENT_NATIONAL", Connection)

            Dim objDataTable As New Data.DataTable("PATIENT_NATIONAL")
            Dim objDataRow As DataRow
            ...
            If objDataTable.Rows.Count > 0 Then
                For Each objDataRow In objDataTable.Rows
                    ...
                    If RecStatus.Trim = "YES" Or RecStatus.Trim = "Yes" Or RecStatus.Trim = "" Then
                    ...
                    If objDataRow.IsNull("P_DNAME") = True Then
                        txtDName.Text = "X"
                    Else
    ...
    Private Sub txtName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtName.KeyDown
        If e.KeyCode = Keys.Enter Then txtName.Text = StrConv(txtName.Text, VbStrConv.ProperCase) : cmbDTitle.Focus()
    End Sub

    Private Sub cmbDTitle_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        cmbDTitle.SelectAll()
    End Sub

    Private Sub cmbDTitle_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then txtDName.Focus()
    End Sub

    Private Sub txtDName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        txtDName.SelectAll()
    End Sub
    ...
    Private Sub cmdCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCancel.Click
        ...
        If Val(strDiff) <> 0 And Val(lblTotal.Text) > 0 Then
            SqlString = "UPDATE PATIENT_NATIONAL SET p_delete = " & Val(lblTotal.Text) & ", p_del_paid = " & Val(txtPaid.Text) & ", p_del_dues = " & Val(lblDues.Text) & ", p_del_disc = " & Val(txtDiscount.Text) & "," & _
        ...
        If Val(strDiff) = 0 And Val(lblTotal.Text) > 0 Or Val(strDiff) = 0 Then
            SqlString = "UPDATE PATIENT_NATIONAL SET p_delete = 0, p_total = 0, p_paid = 0, p_dues = 0, p_discount = 0, p_other = 0, p_del_ok = 'Cancelled', p_del_operator = '" & SysOperator.Trim & "', p_del_date = '" & Format(Now(), "MM/dd/yyyy") & "'," & _
                                            " p_del_time = '" & Format(Now(), "hh:mm tt") & "', p_delete_on = '" & Format(Now(), "MM/dd/yyyy") & "', p_edit_opr = '" & SysOperator.Trim & "'," & _
                                            " p_edit_on = '" & Format(Now(), "MM/dd/yyyy") & "', p_reason = '" & StrConv(Reason.Trim, VbStrConv.ProperCase) & "' WHERE p_num = " & Val(txtRecNo.Text)
        End If
        ...
        Dim CommandText As String = "DELETE FROM RECEIPT_NATIONAL WHERE TCASENO = " & Val(txtRecNo.Text)
        SqlDataAdapt.Dispose()
        SqlDataSet.Clear()
        Execute_DatabaseTable_Query(SqlDataAdapt, CommandText, Connection)
        Connection.Close()
    ...
    Private Sub cmdComp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdComp.Click
        ...
        Dim strDiff As String = DateDiff(DateInterval.Day, Date.Today, strDate)
        If Val(strDiff) <> 0 And Val(lblTotal.Text) > 0 Then
            SqlString = "UPDATE PATIENT_NATIONAL SET p_compliment = " & Val(lblTotal.Text) & ", p_com_paid = " & Val(txtPaid.Text) & ", p_com_dues = " & Val(lblDues.Text) & ", p_com_disc = " & Val(txtDiscount.Text) & "," & _
        ...
        If Val(strDiff) = 0 And Val(lblTotal.Text) > 0 Or Val(strDiff) = 0 Then
            SqlString = "UPDATE PATIENT_NATIONAL SET p_compliment = " & Val(lblTotal.Text) & ", p_paid = 0, p_dues = 0, p_discount = 0, p_other = 0, p_del_ok = 'Complimentary', p_del_operator = '" & SysOperator.Trim & "', p_del_date = '" & Format(Now(), "MM/dd/yyyy") & "'," & _
                                            " p_del_time = '" & Format(Now(), "hh:mm tt") & "', p_comp_on = '" & Format(Now(), "MM/dd/yyyy") & "', p_comp_by = '" & SysOperator.Trim & "', p_edit_opr = '" & SysOperator.Trim & "'," & _
                                            " p_edit_on = '" & Format(Now(), "MM/dd/yyyy") & "', p_reason = '" & StrConv(Reason.Trim, VbStrConv.ProperCase) & "' WHERE p_num = " & Val(txtRecNo.Text)
        End If
    ...
    Private Sub cmbDTitle_SelectedIndexChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbDTitle.SelectedIndexChanged
