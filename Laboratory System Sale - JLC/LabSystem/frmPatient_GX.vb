...
Public Class frmPatient_GX
    ...
    Private Sub frmPATIENT_GX_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        'Connection = New SqlConnection("Data Source=" & ServerName & ";Initial Catalog=JLC;NETWORK LIBRARY=DBMSSOCN;Integrated Security=SSPI;")
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        ...
        Try
            ...
            Dim MaxSn As String = ""
            Dim cpReader As SqlDataReader
            ExecuteSqlQuery(SqlDataAdapt, myDataSet, "Select Max(P_NUM) AS MAX_ID from PATIENT_GX", "PATIENT_GX", Connection)
            cpReader = SqlDataAdapt.SelectCommand.ExecuteReader
            While cpReader.Read
            ...
            ExecuteSqlQuery(SqlDataAdapt, myDataSet, "Select Max(P_SNO) AS MAX_ID from PATIENT_GX WHERE P_DATE_SAMPLE = CONVERT(DATETIME,'" & Format(DateTime.Parse(Date.Now.ToShortDateString), "MM/dd/yyyy") & " 00:00:00',102)", "PATIENT", Connection)
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim IF_EXIST_RECORD As String = "SELECT COUNT(P_NUM) AS EXPR_1 FROM PATIENT_GX WHERE P_NUM = " & Val(txtRecNo.Text)
        ...
        Try
            ...
            If iCount > 0 And Sub_Addition = True Then
                Do Until iLoop = iCount
                    CommandText = "INSERT INTO RECEIPT_GX(TCASENO,TCODE,TNAME,TCATG,TRATE,TQTY,TDATE,TMODE) VALUES (" & _
                             Val(txtRecNo.Text) & ",'" & _
            ...
            Dim svSql As String = "Select * from PATIENT_GX WHERE P_NUM = " & Val(txtRecNo.Text)
            SqlDataAdapt = New SqlDataAdapter(svSql, Connection)
            SqlDataAdapt.Fill(svDataSet, "PATIENT_GX")
            Connection.Close()
            ...
            svDataRow = svDataSet.Tables("PATIENT_GX").NewRow()
            ...
            svDataRow.Item("P_SEX") = lblSex.Text.Trim
            ...
            svDataRow.Item("P_SNO") = Val(txtSNo.Text)
            ...
            svDataSet.Tables("PATIENT_GX").Rows.Add(svDataRow)
            SqlDataAdapt.Update(svDataSet, "PATIENT_GX")
        ...
        Try
            ...
            If Val(lblDues.Text) > 0 Then
                ...
                If Val(strDiff) <> 0 And DueAmount > 0 Then
                    CommandText = "UPDATE PATIENT_GX SET P_DEL_OK = 'Yes', P_DEL_DATE = '" & _
        ...
        Try
            ...
            If objDataTable.Rows.Count > 0 Then
                For Each objDataRow In objDataTable.Rows
                    ...
                    TestListView.Items.Clear()
                    ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, "SELECT * FROM RECEIPT_GX WHERE TCASENO = " & Val(gblFind.Trim), "RECEIPT_GX", Connection)
    ...
    Private Sub cmdPSlip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPSlip.Click
        ...
        If Len(gblFind) > 0 Then
            ...
            gblReportName = ".\" & "Reports\GXPatientSlip.rpt"
    ...
    Private Sub cmdLSlip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLSlip.Click
        ...
        If Len(gblFind) > 0 Then
            gblReportOption = "GXRECEIPT"
            'DiskReport = "LabSlip"
            gblReportName = ".\" & "Reports\GXLabSlip.rpt"
