...
Public Class frmPatient_Jinnah
    ...
    Private Sub frmPATIENT_JINNAH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCode.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If txtName.Text = "" Or txtRefer.Text = "" Then _
                                MsgBox("Basic Information of Patient is Missing.", MsgBoxStyle.Information, My.Application.Info.ProductName) _
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        ...
        Try
            ...
            Dim MaxSn As String = ""
            Dim cpReader As SqlDataReader
            ExecuteSqlQuery(SqlDataAdapt, myDataSet, "Select Max(P_NUM) AS MAX_ID from PATIENT_JINNAH", "PATIENT_JINNAH", Connection)
            cpReader = SqlDataAdapt.SelectCommand.ExecuteReader
            While cpReader.Read
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim IF_EXIST_RECORD As String = "SELECT COUNT(P_NUM) AS EXPR_1 FROM PATIENT_JINNAH WHERE P_NUM = " & Val(txtRecNo.Text)
        ...
        Try
            ...
            Dim svSql As String = "Select * from PATIENT_JINNAH WHERE P_NUM = " & Val(txtRecNo.Text)
            SqlDataAdapt = New SqlDataAdapter(svSql, Connection)
            SqlDataAdapt.Fill(svDataSet, "PATIENT_JINNAH")
            Connection.Close()
            ...
            svDataRow = svDataSet.Tables("PATIENT_JINNAH").NewRow()
            ...
            svDataSet.Tables("PATIENT_JINNAH").Rows.Add(svDataRow)
            SqlDataAdapt.Update(svDataSet, "PATIENT_JINNAH")
        ...
        Try
            ...
            If Val(lblDues.Text) > 0 Then
                ...
                If Val(strDiff) <> 0 And DueAmount > 0 Then
                    CommandText = "UPDATE PATIENT_JINNAH SET P_DEL_OK = 'Yes', P_DEL_DATE = '" & _
