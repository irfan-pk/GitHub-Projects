...
Public Class frmSTEdit
    ...
    Private Sub frmSTEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCode.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            Dim CommandText As String = "SELECT * FROM RECEIPT_ST where tcode = '" & txtCode.Text.Trim & "' AND TCASENO = " & Val(txtRecNo.Text.Trim)
            ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, CommandText, "RECEIPT_ST", Connection)
            SqlDataAdapt.Fill(SqlDataSet, "RECEIPT_ST")
            If SqlDataSet.Tables("RECEIPT_ST").Rows.Count > 0 Then
            ...
            Try
                ...
                If objDataTable.Rows.Count > 0 Then
                    ...
                    Dim EditCommandText As String = "INSERT INTO RECEIPT_ST VALUES (" & _
                                                    Val(txtRecNo.Text) & ",'" & _
                                                    strTCode & "','" & _
                                                    strTname & "','" & _
                                                    strCatg & "'," & _
                    ...
                    Connection.Close()
                    SqlDataAdapt.Dispose()
                    Call ShowGridData("SELECT * FROM RECEIPT_ST", "RECEIPT_ST", txtRecNo.Text)
                    txtCode.Clear()
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If isChanged = True Then
            Try
                ...
                mySql = "UPDATE PATIENT_ST SET P_NAME = '" & StrConv(txtName.Text.Trim, VbStrConv.ProperCase) & "'," & _
                        " P_AGE = '" & myAge & "'," & _
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Dim strSql As String = "Select * from RECEIPT_ST WHERE TCODE = '" & DelString.Trim & "' AND TCASENO = " & Val(txtRecNo.Text)
        ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, strSql, "RECEIPT_ST", Connection)
        ...
        Try
            ...
            Dim CommandText As String = "DELETE FROM RECEIPT_ST WHERE TCODE = '" & DelString.Trim & "' AND TCASENO = " & Val(txtRecNo.Text)
            SqlDataAdapt.Dispose()
            SqlDataSet.Clear()
        ...
        End Try
        ' Refresh Data Grid
        Call ShowGridData("SELECT * FROM RECEIPT_ST", "RECEIPT_ST", txtRecNo.Text.Trim)
        Connection.Close()
        SqlDataAdapt.Dispose()
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        Try
            ...
            Dim strSql As String = "Select * from PATIENT_ST WHERE P_NUM = " & Val(gblFind.Trim)
            ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, strSql, "PATIENT_ST", Connection)

            Dim objDataTable As New Data.DataTable("PATIENT_ST")
            Dim objDataRow As DataRow
    ...
    Private Sub cmdCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCancel.Click
        ...
        If Val(strDiff) <> 0 And Val(lblTotal.Text) > 0 Then
            SqlString = "UPDATE PATIENT_ST SET p_delete = " & Val(lblTotal.Text) & ", p_del_paid = " & Val(txtPaid.Text) & ", p_del_dues = " & Val(lblDues.Text) & ", p_del_disc = " & Val(txtDiscount.Text) & "," & _
        ...
        If Val(strDiff) = 0 And Val(lblTotal.Text) > 0 Or Val(strDiff) = 0 Then
            SqlString = "UPDATE PATIENT_ST SET p_delete = 0, p_total = 0, p_paid = 0, p_dues = 0, p_discount = 0, p_other = 0, p_del_ok = 'Cancelled', p_del_operator = '" & SysOperator.Trim & "', p_del_date = '" & Format(Now(), "MM/dd/yyyy") & "'," & _
                                            " p_del_time = '" & Format(Now(), "hh:mm tt") & "', p_delete_on = '" & Format(Now(), "MM/dd/yyyy") & "', p_edit_opr = '" & SysOperator.Trim & "'," & _
                                            " p_edit_on = '" & Format(Now(), "MM/dd/yyyy") & "', p_reason = '" & StrConv(Reason.Trim, VbStrConv.ProperCase) & "' WHERE p_num = " & Val(txtRecNo.Text)
        End If
        ...
        Dim CommandText As String = "DELETE FROM RECEIPT_ST WHERE TCASENO = " & Val(txtRecNo.Text)
        SqlDataAdapt.Dispose()
        SqlDataSet.Clear()
        Execute_DatabaseTable_Query(SqlDataAdapt, CommandText, Connection)
        Connection.Close()
    ...
    Private Sub cmdComp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdComp.Click
        ...
        Dim strDiff As String = DateDiff(DateInterval.Day, Date.Today, strDate)
        If Val(strDiff) <> 0 And Val(lblTotal.Text) > 0 Then
            SqlString = "UPDATE PATIENT_ST SET p_compliment = " & Val(lblTotal.Text) & ", p_com_paid = " & Val(txtPaid.Text) & ", p_com_dues = " & Val(lblDues.Text) & ", p_com_disc = " & Val(txtDiscount.Text) & "," & _
        ...
        If Val(strDiff) = 0 And Val(lblTotal.Text) > 0 Or Val(strDiff) = 0 Then
            SqlString = "UPDATE PATIENT_ST SET p_compliment = " & Val(lblTotal.Text) & ", p_paid = 0, p_dues = 0, p_discount = 0, p_other = 0, p_del_ok = 'Complimentary', p_del_operator = '" & SysOperator.Trim & "', p_del_date = '" & Format(Now(), "MM/dd/yyyy") & "'," & _
                                            " p_del_time = '" & Format(Now(), "hh:mm tt") & "', p_comp_on = '" & Format(Now(), "MM/dd/yyyy") & "', p_comp_by = '" & SysOperator.Trim & "', p_edit_opr = '" & SysOperator.Trim & "'," & _
                                            " p_edit_on = '" & Format(Now(), "MM/dd/yyyy") & "', p_reason = '" & StrConv(Reason.Trim, VbStrConv.ProperCase) & "' WHERE p_num = " & Val(txtRecNo.Text)
        End If
