...
#Region "Create database"
    ...
    Private Sub CreateDatabase()
        Dim sqlStatement As String = _
            "CREATE DATABASE POS " & _
            "ON PRIMARY ( NAME = POS,FILENAME = '" & gblDatabasePath & "\POS.mdf',SIZE = 10,MAXSIZE = UNLIMITED,FILEGROWTH = 1024KB) " & _
            "LOG ON ( NAME = POS_log,FILENAME = '" & gblDatabasePath & "\POS_log.ldf',SIZE = 5MB,MAXSIZE = UNLIMITED,FILEGROWTH = 10% )"
    ...
    Private Sub btnCreateTable_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateTable.Click
        ...
        If CheckTableExists("PRODUCTS") = False Then
            Try
                ...
                SqlCommand(1) = "CREATE TABLE SUPPLIERS_JOURNAL(" & _
                ...
                SqlCommand(13) = "CREATE TABLE CUSTOMERS_PAYM(" & _
