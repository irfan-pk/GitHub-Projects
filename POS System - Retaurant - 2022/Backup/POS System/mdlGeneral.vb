...
Module mdlGeneral 
    Public Title, Address, Contact, TableName As String
    ...
    Public SaveServerSettings, LoginStatus, gblRelation, gblOrder As Boolean
    ...
    Public ConnString, SqlConnString, UserStatus, UserName, UserPassword, UserID, SysOperator, DiscountBy, RptUser, gblAccType, gblInput, gbl_IName(99), gbl_IQty(99), gbl_ICode(99), gblDataArray(50, 2) As String
    ...
    Public gblPrliviges, gblAccLink, gblArrayCount As Integer
    ...
    Public Sub Print_Slips_Manually()
        ...
        If gblReportOption.ToUpper = "RECEIPT" Then
            ...
            CommandText = "Select * from SALE_MASTER WHERE SaleID = " & Val(gblFind.Trim)
        End If

        If gblReportOption.ToUpper = "DUE_RECEIPT" Then
            TableName = "TABLE_MASTER"
            CommandText = "Select * from TABLE_MASTER WHERE SaleID = " & Val(gblFind.Trim)
        End If
        ...
        With objReport
            ...
            If gblReportOption.ToUpper = "RECEIPT" Then .RecordSelectionFormula = "{sale_master.saleid}=" & Val(gblFind)
            If gblReportOption.ToUpper = "DUE_RECEIPT" Then .RecordSelectionFormula = "{table_master.saleid}=" & Val(gblFind)
            ...
            For c = 0 To doctoprint.PrinterSettings.PaperSizes.Count - 1
                If doctoprint.PrinterSettings.PaperSizes(c).PaperName = "Receipt" Then
    ...
    Public Function CheckTableExists(ByVal tblname As String) As Boolean
        ...
        Dim conn As New SqlConnection("Data Source=SQLNCLI10;Integrated Security=SSPI;Persist Security Info=False;User ID=sa;Password=" & ServerPwd & ";Data Source=" & ServerName & ";DATABASE=POSR;")  'Creates a new connection object
    ...
    Function AmtInWord(ByVal Num As Decimal) As String
        ...
        If InStr(1, strNum, ".") <> 0 Then
            ...
            StrWord = IIf(CDbl(strNum) = 1, "Rupee ", "Rupees ") + NumToWord(CDbl(strNum)) + IIf(CDbl(strNumDec) > 0, " and Paise" + cWord3(CDbl(strNumDec)), String.Empty)
        Else
    ...
    Function cWordG3(ByVal Num As Decimal) As String
        ...
        Dim readNum As String = String.Empty
        strNum = Num
    ...
    Function retWord(ByVal Num As Decimal) As String
        ...
        retWord = String.Empty
        Dim ArrWordList(,) As Object = {{0, String.Empty}, {1, "One"}, {2, "Two"}, {3, "Three"}, {4, "Four"}, _
    ...
    Public Function CheckRecordExists(ByVal strFind As String, ByVal tblName As String, ByVal strField As String) As Boolean
