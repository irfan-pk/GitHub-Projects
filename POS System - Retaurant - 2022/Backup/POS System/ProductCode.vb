...
Public Class ProductCode
    ...
    Private Sub frmProductCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            Try
                ...
                gblItemCode = ProductCodeDataset.Tables("PRODUCTS").Rows(0).Item("PROD_CD").ToString.Trim
                Connection.Close()
                'Me.Close()
    ...
    Private Sub MainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        While Reader.Read
            dtTest.Rows.Add(Reader.Item("prod_cd".ToString.Trim), Reader.Item("prod_desc").ToString.Trim)
        End While
