...
namespace POS_System.My
{
    ...
    internal sealed partial class MySettings : System.Configuration.ApplicationSettingsBase
    {
        ...
        */
        ...
        [System.Configuration.DefaultSettingValue("Data Source=HOME-PC;Initial Catalog=POSR;Integrated Security=True")]
        public string POSConnectionString
        {
            get
            {
                return Conversions.ToString(this["POSConnectionString"]);
            }
        }
    }
}
