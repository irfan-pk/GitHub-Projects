...
#Region "Forms and TextBoxes Events"
    ...
    Private Sub txtSalePrice_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtSalePrice.KeyDown
        If e.KeyCode = Keys.Enter Then
            If Val(txtPPrice.Text) < 1 Then gblMessage = "Purchase Price invalid ?" : frmMsgStatus.ShowDialog(Me) : Exit Sub
    ...
    Private Sub txtSalePrice_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSalePrice.LostFocus
        ...
        If Val(txtSalePrice.Text) <= 0 Then gblMessage = "Purchase Price invalid ?" : frmMsgStatus.ShowDialog(Me) : txtSalePrice.Text = 0 : Exit Sub
        txtMargin.Text = Val(txtSalePrice.Text) - Val(txtPPrice.Text) - Val(txtVAT.Text.Trim) - Val(txtITax.Text.Trim) - Val(txtEDuty.Text.Trim)
        txtSalePrice.Text = Val(txtPPrice.Text) + Val(txtVAT.Text.Trim) + Val(txtITax.Text.Trim) + Val(txtEDuty.Text.Trim) + Val(txtMargin.Text.Trim)
        txtDiscount.Text = Val(txtSalePrice.Text) * (0.01)
        'txtDiscount.Focus()
    ...
    Private Sub Get_Text_Values()
        ...
        If CheckCellValue(PurchaseDataGridView) = True Then gblMessage = "No data to edit" : frmMsgStatus.ShowDialog(Me) : Exit Sub
        ...
        If PurchaseDataGridView.Rows(PurchaseDataGridView.CurrentRow.Index).Cells(24).Value.ToString.Trim = "ADDED" Then
            ...
            txtSch1.Text = PurchaseDataGridView.Rows(PurchaseDataGridView.CurrentRow.Index).Cells(12).Value.ToString
            txtSQty1.Text = PurchaseDataGridView.Rows(PurchaseDataGridView.CurrentRow.Index).Cells(13).Value.ToString
            txtSch2.Text = PurchaseDataGridView.Rows(PurchaseDataGridView.CurrentRow.Index).Cells(14).Value.ToString
            txtSQty2.Text = PurchaseDataGridView.Rows(PurchaseDataGridView.CurrentRow.Index).Cells(15).Value.ToString
            txtSch3.Text = PurchaseDataGridView.Rows(PurchaseDataGridView.CurrentRow.Index).Cells(16).Value.ToString
            txtSQty3.Text = PurchaseDataGridView.Rows(PurchaseDataGridView.CurrentRow.Index).Cells(17).Value.ToString
...
#End Region
    ...
    Private Sub PurchaseDataGridView_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles PurchaseDataGridView.KeyUp
        ...
        If e.KeyCode = Keys.F8 Then
            ...
            If CheckCellValue(PurchaseDataGridView) = True Then gblMessage = "No data to delete" : frmMsgStatus.ShowDialog(Me) : Exit Sub
