...
Public Class frmCustPurchases
    ...
    Private Sub BindingNavigatorFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BindingNavigatorFind.Click
        If BindingNavigatorTextBox.Text = "" Or Val(BindingNavigatorTextBox.Text.Trim) = 0 Then gblMessage = "Please valid customer ID to Search ?" : frmMsgStatus.ShowDialog(Me) : Exit Sub
        Popup_SaleData()
    End Sub
