...
Module mdlGeneral
    Public intInputBoxCancel, DrawerID As Integer
    Public Title, Address, Contact, gblRefer, gblAccHead, gblAccName, gblTableName, HelpQuery, HelpTable, HelpCode, HelpF1, HelpF2, gblQuery, gblInvoiceStatus As String
    ...
    Public OpnCr, OpnDr, Ledg_BF, New_Balance, Final_Cr, Final_Dr, gblLedgBal As Double
    ...
    Public ConnString, SqlConnString, UserStatus, UserName, UserPassword, UserID, SysOperator, DiscountBy, RptUser, gblAccType, gblInput, gblDatabasePath, gblExtDesc, gblExtPrice, gblInvPrefix, gblGross As String
    ...
    Public intTotal, intPaid, intDues, intOpnCr, intOpnDr, intD_Paid, intD_Dues, intD_Disc, intD_Recv, gblRefund, gblPayment, gblNet, gblDues, gblBalBF, gblDiff As Double
    ...
    Public Sub Get_Property_LostFocus(ByVal MyObject As Object)
        MyObject.BackColor = Color.White
        MyObject.ForeColor = Color.Black
    End Sub
    ...
    Public Sub ValidateNumericKeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs, ByVal txt As TextBox)
                ...
                Using reader As SqlDataReader = sqlCmd.ExecuteReader
                    If reader.HasRows Then
                        While reader.Read
                            ...
                            Dim balUpd As String = "SELECT * FROM LEDGERS WHERE (LEDG_ACC_ID = " & reader.Item("acc_no") & ") ORDER BY LEDG_DATE, LEDG_TRAN_ID"
                            ExecuteAdapterQuery(SqlDataAdapter, balUpd, Connection)
                            ...
                            If BalUpdater.HasRows Then
                                While BalUpdater.Read
                                    ...
                                    Dim MyQuery As String = "update ledgers set ledg_balance = " & UpdateBal & _
                                                            ...
                                                            " AND (LEDG_TRAN_ID = " & BalUpdater.Item("ledg_tran_id") & ")"
    ...
    Public Sub Get_Account_Parameters(ByVal strAccID As Integer)
        Dim AccLnkID_Text As String = "SELECT ACC_HEAD,ACC_TYPE,ACC_NAME,ACC_BALANCE FROM ACCOUNTS WHERE ACC_NO = " & strAccID
        ExecuteAdapterQuery(SqlDataAdapter, AccLnkID_Text, Connection)
        ...
        While Reader.Read
            ...
            gblLedgBal = Convert.ToDouble(Reader.Item("ACC_BALANCE"))
        End While
        If Not Reader Is Nothing Then Reader.Close()
    End Sub

    Public Sub Get_Ledger_Parameters(ByVal strAccID As Integer)
        Dim AccLnkID_Text As String = "SELECT ledg_balance FROM LEDGERS WHERE LEDG_ACC_ID = " & strAccID
        ExecuteAdapterQuery(SqlDataAdapter, AccLnkID_Text, Connection)
        Dim Reader As SqlDataReader
        Reader = SqlDataAdapter.SelectCommand.ExecuteReader
        While Reader.Read
            gblLedgBal = Convert.ToDouble(Reader.Item("ledg_balance"))
        End While
        If Not Reader Is Nothing Then Reader.Close()
    End Sub
