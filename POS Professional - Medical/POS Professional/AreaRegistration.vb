...
Public Class AreaRegistration
    ...
    Private Sub AreaRegistration_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If txtAreaName.Text = String.Empty Or txtAreaSN.Text = String.Empty Then MsgBox("Please fill all data.", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly) : Exit Sub
