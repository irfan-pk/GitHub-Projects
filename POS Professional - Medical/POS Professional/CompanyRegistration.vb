...
Public Class CompanyRegistration
    ...
    Private Sub CompanyRegistration_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
            ...
            If Len(txtSeq.Text) > 0 Then
                ...
                If FindReader.HasRows = True Then
                    While FindReader.Read
                        ...
                        txtAreaCode.Text = FindReader.Item("companyareacode").ToString()
