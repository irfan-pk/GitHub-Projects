...
Public Class CustomerReports
    ...
    Private Sub CustomerReports_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        CustomerMenu.WindowState = FormWindowState.Normal
    End Sub
    ...
    Private Sub CustomerReports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim FillCombo As String = "SELECT * FROM ACCOUNTS WHERE ACC_REG_TYPE = 'CUSTOMER' ORDER BY ACC_NO"
        ...
        If Reader.HasRows Then
            While Reader.Read
                cmbCustName.Items.Add(Reader.Item("ACC_NO").ToString & " - " & Reader.Item("ACC_NAME").ToString)
            End While
