...
Module mdlGeneral
    ...
    Public Title, Address, Contact, gblRefer, gblAccHead, gblAccName, gblTableName, HelpQuery, HelpTable, HelpCode, HelpF1, HelpF2, gblQuery As String
    ...
    Public OpnCr, OpnDr, Ledg_BF, New_Balance, Final_Cr, Final_Dr, LedgBal As Double
    ...
    Public Sub Get_Account_Parameters(ByVal strAccID As Integer)
        ...
        While Reader.Read
            ...
            LedgBal = Convert.ToDouble(Reader.Item("ACC_BALANCE"))
        End While
    ...
    Public Sub Get_Ledger_Parameters(ByVal strAccID As Integer)
        ...
        Reader = SqlDataAdapter.SelectCommand.ExecuteReader
        While Reader.Read
            LedgBal = Convert.ToDouble(Reader.Item("ledg_balance"))
        End While
        If Not Reader Is Nothing Then Reader.Close()
    End Sub
