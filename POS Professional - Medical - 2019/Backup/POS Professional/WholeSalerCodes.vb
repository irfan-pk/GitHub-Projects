...
Public Class WholesalerCodes
    ...
    Private Sub SuplCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            Try
                ...
                gblCP_ID = ProductCodeDataset.Tables("ACCOUNTS").Rows(0).Item("ACC_NO").ToString.Trim
                Connection.Close()
    ...
    Private Sub MainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim CommandText As String = "SELECT * FROM ACCOUNTS WHERE ACC_REG_TYPE = 'COMPANY' ORDER BY ACC_NAME"
