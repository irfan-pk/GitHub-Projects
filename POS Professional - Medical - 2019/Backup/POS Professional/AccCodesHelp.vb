...
Public Class AccCodesHelp
    ...
    Private Sub ComboBox1_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ComboBox1.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            Try
                Dim CommandText As String = "SELECT ACC_NO, ACC_NAME FROM ACCOUNTS WHERE ACC_NAME = N'" & Trim(ComboBox1.Text.Trim) & "'"
    ...
    Private Sub AccCodesHelp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call GetConnectionString()
        ExecuteAdapterQuery(ProductCodeAdapter, gblQuery, Connection)
        ...
        While Reader.Read
            dtTest.Rows.Add(Reader.Item("acc_name"), Reader.Item("acc_no").ToString.Trim)
        End While
