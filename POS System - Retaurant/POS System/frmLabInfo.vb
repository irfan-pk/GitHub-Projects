...
Public Class frmLabInfo
    ...
    Private Sub frmLabInfo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ExecuteSqlQuery(SqlDataAdapt, SqlDataSet, "SELECT * FROM LAB_INFO", "LAB_INFO", Connection)
        Dim LabInformation As SqlDataReader = SqlDataAdapt.SelectCommand.ExecuteReader
    ...
    Private Sub cmdUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUpdate.Click
        ...
        Dim UpdateQuery As String = "UPDATE LAB_INFO SET LAB_NAME = '" & txtLabName.Text.Trim.ToUpper & "'," & _
        ...
        Execute_DatabaseTable_Query(SqlDataAdapt, UpdateQuery, Connection)
        SqlDataAdapt.Dispose()
        Connection.Close()
