...
#Region "Create database"
    ...
    Private Sub CreateDatabase()
        Dim sqlStatement As String = _
            ...
            "WHERE Name = 'POSR')" & vbCrLf & _
            "CREATE DATABASE POSR"
        ...
        If CheckTableExists("PRODUCTS") = False Then
            Try
                ...
                SqlCommand(1) = "CREATE TABLE TABLE_MASTER(" & _
                                ...
                                "SaleTotal decimal(18, 0) NULL," & _
                                "SalePaid decimal(18, 0) NULL," & _
                                "SaleDiscount decimal(18, 0) NULL," & _
                                "SaleChange decimal(18, 0) NULL," & _
                                "SaleStatus int NULL," & _
                                "SaleCredit decimal(18, 0) NULL," & _
                                "SaleReturn decimal(18, 0) NULL," & _
                                "SaleRecovery decimal(18, 0) NULL," & _
                ...
                SqlCommand(19) = "CREATE TABLE WAITERS(" & _
                                 "WAITER_ID int NULL," & _
                                 "WAITER_NAME varchar(100) NULL," & _
                                 "WAITER_ADDRESS varchar(200) NULL," & _
                                 "WAITER_CONTACT varchar(11) NULL," & _
