...
Public Class WaiterCode
    Private Sub frmCustCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            Try
                Dim CommandText As String = "SELECT * FROM WAITERS WHERE WAITER_NAME = N'" & Trim(ListBox1.Text.Trim) & "'"
                ExecuteDatasetQuery(ProductCodeAdapter, ProductCodeDataset, CommandText, "WAITERS", Connection)
                gblCP_ID = ProductCodeDataset.Tables("WAITERS").Rows(0).Item("WAITER_ID").ToString.Trim
                gblCP = ProductCodeDataset.Tables("WAITERS").Rows(0).Item("WAITER_NAME").ToString.Trim
                Connection.Close()
                'Me.Close()
    ...
    Private Sub MainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Reader.HasRows = False Then
            gblMessage = "Please add waiter first in the table."
        ...
        While Reader.Read
            dtTest.Rows.Add(Reader.Item("waiter_id".ToString.Trim), Reader.Item("waiter_name").ToString.Trim)
        End While
