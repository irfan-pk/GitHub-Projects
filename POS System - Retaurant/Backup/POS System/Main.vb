...
Public Class Main
    ...
    Private Sub cmdDining_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDining.Click
        Call ShowForm(DineTable)
    End Sub
End Class
