...
Public Class Reports
    ...
    Private Sub frmReports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If gblReportOption.ToUpper = "LEDGER" Then
            ...
            If RptUser.ToUpper <> "ALL" Then CommandText = "SELECT * FROM CUSTOMERS WHERE CUST_CODE = " & Val(RptUser.Trim) & " AND CUST_TR_DT >= CONVERT(DATETIME,'" & Format(FromDate, "yyyy-MM-dd") & " 00:00:00',102) ORDER BY CUST_CODE"
        End If
        ...
        If gblReportOption.ToUpper = "WLEDGER" Then
            ...
            If RptUser.ToUpper <> "ALL" Then CommandText = "SELECT * FROM SUPPLIERS WHERE SUPL_CODE = " & Val(RptUser.Trim) & " AND SUPL_TR_DT >= CONVERT(DATETIME,'" & Format(FromDate, "yyyy-MM-dd") & " 00:00:00',102) ORDER BY SUPL_CODE"
        End If
