...
Public Class ProductCode
    ...
    Private Sub ProductCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then gblItemCode = String.Empty : Me.Close()
        If e.KeyCode = Keys.Enter Then
            Try
                Dim CommandText As String = "SELECT * FROM PRODUCTS WHERE PROD_DESC = N'" & Trim(comboBox1.Text.Trim) & "'"
                ExecuteDatasetQuery(ProductCodeAdapter, ProductCodeDataset, CommandText, "PRODUCTS", Connection)
                gblItemCode = ProductCodeDataset.Tables("PRODUCTS").Rows(0).Item("PROD_CODE").ToString.Trim
                Connection.Close()
    ...
    Private Sub MainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim CommandText As String = "SELECT * FROM PRODUCTS ORDER BY PROD_DESC"
        ...
        If Reader.HasRows = False Then
            gblMessage = "Please add product in the table."
        ...
        While Reader.Read
            dtTest.Rows.Add(Reader.Item("prod_desc".ToString.Trim), Reader.Item("prod_code").ToString.Trim)
        End While
