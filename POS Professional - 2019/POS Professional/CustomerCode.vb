...
Public Class CustomerCode
    ...
    Private Sub CustomerCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            Try
                Dim CommandText As String = "SELECT * FROM CUSTOMERS WHERE CUST_NAME = N'" & Trim(ComboBox1.Text.Trim) & "'"
                ExecuteDatasetQuery(ProductCodeAdapter, ProductCodeDataset, CommandText, "CUSTOMERS", Connection)
                gblCP_ID = Val(ProductCodeDataset.Tables("CUSTOMERS").Rows(0).Item("CUST_CODE").ToString.Trim)
    ...
    Private Sub CustomerCode_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Reader.HasRows = False Then
            gblMessage = "Please add custoemrs in the data table."
        ...
        While Reader.Read
            dtTest.Rows.Add(Reader.Item("cust_name".ToString.Trim), Reader.Item("cust_code").ToString.Trim)
        End While
