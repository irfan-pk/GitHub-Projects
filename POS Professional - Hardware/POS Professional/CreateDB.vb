...
#Region "Create database"
    ...
    Private Sub CreateDatabase()
        Dim sqlStatement As String = _
            "CREATE DATABASE POS_HW " & _
            "ON PRIMARY ( NAME = POS_HW,FILENAME = '" & gblDatabasePath & "\POS_HW.mdf',SIZE = 10,MAXSIZE = UNLIMITED,FILEGROWTH = 1024KB) " & _
            "LOG ON ( NAME = POS_HW_log,FILENAME = '" & gblDatabasePath & "\POS_HW_log.ldf',SIZE = 5MB,MAXSIZE = UNLIMITED,FILEGROWTH = 10% )"
    ...
    Private Sub btnCreateTable_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreateTable.Click
        ...
        If CheckTableExists("PRODUCTS") = False Then
            Try
                ...
                SqlCommand(2) = "CREATE TABLE VENDORS(" & _
                                "Supl_Code int NULL," & _
                                "Supl_Name varchar(50) NULL," & _
                ...
                SqlCommand(13) = "CREATE TABLE CUSTOMERS(" & _
                                 "Cust_Code int NULL," & _
                                 "Cust_Name varchar(50) NULL," & _
                ...
                SqlCommand(14) = "CREATE TABLE UsersRoles(" & _
                                 "RoleID int NULL," & _
                                 "RoleName char(50) NULL," & _
                                 "Decription char(250) NULL," & _
                                 "SecurityLevel int NULL)"

                SqlCommand(15) = "CREATE TABLE [dbo].[CATEGORY](" & _
                                 "[CATEGORY_ID] [int] NULL," & _
                                 "[HEAD] [varchar](255) NULL," & _
                                 "[CATEGORY] [varchar](255) NULL" & _
                                 ") ON [PRIMARY]"

                SqlCommand(16) = "CREATE TABLE [dbo].[HEADS](" & _
                                 "[HEADS_NAME] [varchar](255) NULL," & _
                                 "[HEAD_ID] [int] NULL" & _
                                 ") ON [PRIMARY]"
