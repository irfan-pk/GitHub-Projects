...
#Region "Form Events and Procedures"
    ...
    Private Sub Purchases_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ExecuteAdapterQuery(SupplierSqlAdapter, "select * from vendors", Connection)
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If ProdInfo.HasRows Then
                While ProdInfo.Read
                    ...
                    OldQuantity = Val(ProdInfo.Item("PROD_IN_HAND").ToString.Trim)
                    ...
                    SubCategory = ProdInfo.Item("prod_brand").ToString.Trim
                End While
