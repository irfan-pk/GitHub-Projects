...
Public Class Products
    ...
    Private Sub LoadData()
        Try
            ...
            ExecuteAdapterQuery(DepartmentSqlAdapter, "select * from heads order by head_name", Connection)
            ...
            If DeptReader.HasRows Then
                While DeptReader.Read
                    cmbHeads.Items.Add(DeptReader.Item("head_name").ToString)
                End While
            ...
            cmbHeads.DataBindings.Add("TEXT", Me.ProductBindingSource, "PROD_HEAD")
            cmbCatg.DataBindings.Add("TEXT", Me.ProductBindingSource, "PROD_CATG")
            txtBrand.DataBindings.Add("TEXT", Me.ProductBindingSource, "PROD_BRAND")
            txtSize.DataBindings.Add("TEXT", Me.ProductBindingSource, "PROD_SIZE")
            cmbPackage.DataBindings.Add("TEXT", Me.ProductBindingSource, "PROD_PACKING")
            txtQtyPack.DataBindings.Add("TEXT", Me.ProductBindingSource, "PROD_QTY_PER_UNIT")
            txtStock.DataBindings.Add("TEXT", Me.ProductBindingSource, "PROD_IN_HAND")
            ...
            txtRetailPrice.DataBindings.Add("TEXT", Me.ProductBindingSource, "PROD_RETAIL_PRICE")
    ...
    Private Sub txtUnitPack_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtQtyPack.GotFocus
        Call Get_Property_GotFocus(txtQtyPack)
    End Sub

    Private Sub txtUnit_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtQtyPack.KeyPress
        If Not (Char.IsControl(e.KeyChar) Or Char.IsDigit(e.KeyChar)) Then e.Handled = True
    End Sub

    Private Sub txtUnit_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtQtyPack.LostFocus
        Call Get_Property_LostFocus(txtQtyPack)
    End Sub

    Private Sub txtPackQty_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Not (Char.IsControl(e.KeyChar) Or Char.IsDigit(e.KeyChar)) Then e.Handled = True
    End Sub
    ...
    Private Sub txtPurchPrice_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtPurchPrice.KeyPress
        ValidateNumericKeyPress(sender, e, txtPurchPrice, txtRetailPrice)
    End Sub
    ...
    Private Sub txtSalePrice_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtRetailPrice.KeyPress
        ValidateNumericKeyPress(sender, e, txtRetailPrice, txtRetailPrice)
    End Sub

    Private Sub txtSalePrice_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtRetailPrice.GotFocus
        Call Get_Property_GotFocus(txtRetailPrice)
    End Sub

    Private Sub txtSalePrice_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtRetailPrice.LostFocus
        Call Get_Property_LostFocus(txtRetailPrice)
    End Sub
    ...
    Private Sub BindingNavigatorUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BindingNavigatorUpdate.Click
        ...
        If txtRetailPrice.Text.Trim = String.Empty Then txtRetailPrice.Text = "0"
        ...
        If ValidateFieldsData(SplitContainer1.Panel1.Controls) = False Then
            ...
            If UpdtMode = True Then
                ...
                UpdateQuery = "INSERT INTO PRODUCTS VALUES('" & _
                                ...
                                cmbHeads.Text.Trim.ToUpper & "','" & _
                                cmbCatg.Text.Trim.ToUpper & "','" & _
                                txtBrand.Text.Trim.ToUpper & "','" & _
                                txtSize.Text.Trim.ToUpper & "','" & _
                                cmbPackage.Text.Trim.ToUpper & "'," & _
                                Val(txtQtyPack.Text.Trim) & "," & _
            ...
            If EditMode = True Then
                UpdateQuery = "UPDATE PRODUCTS SET " & _
                                 ...
                                 "PROD_HEAD = '" & cmbHeads.Text.Trim.ToUpper & "', " & _
                                 "PROD_CATG = '" & cmbCatg.Text.Trim.ToUpper & "', " & _
                                 "PROD_BRAND = '" & txtBrand.Text.Trim.ToUpper & "', " & _
                                 "PROD_SIZE = '" & txtSize.Text.Trim.ToUpper & "', " & _
                                 "PROD_PACKING = '" & cmbPackage.Text.Trim.ToUpper & "', " & _
                                 "PROD_QTY_PER_UNIT = " & Val(txtQtyPack.Text.Trim) & ", " & _
                                 "PROD_IN_HAND = " & Val(txtStock.Text.Trim) & ", " & _
                                 ...
                                 "PROD_RETAIL_PRICE = " & Val(txtRetailPrice.Text.Trim) & ", " & _
